...
#path0="./Datasets/MSKUSO/support/imgs/hp_00001.jpg"
...
ax2.axis('off')
print("Patch grid size:", grid_size)
print("Patch index 0 feature:", patch_features[0][:5])
print("Patch index 36 feature:", patch_features[36][:5])  # 第一行最后一个
print("Patch index 37 feature:", patch_features[37][:5])  # 第二行第一个
