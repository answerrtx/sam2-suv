...
def parse_args():
    ...
    parser.add_argument("--lightglue_model", required=False, default="./checkpoints/superpoint_lightglue_pipeline.ort.onnx")
...
def main():
    ...
    support_img = Image.open(args.support_img_path)
    ...
    for fname in frame_list:
        ...
        matches, img0_resized, img0_size, img1_size = run_lightglue_onnx(image_path, args.support_img_path, args.lightglue_model)
        labels = []
