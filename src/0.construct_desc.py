...
prompt_text = "The first is an ultrasound image; the second is a mask. the mask of color (255, 0, 0) indicates the Vertebral Arch. Briefly describe its the transducer direction, color (not mask color), shape, and morphominetic. Then summarize in a paragraph. When summrazing, don't indicate the mask color"
